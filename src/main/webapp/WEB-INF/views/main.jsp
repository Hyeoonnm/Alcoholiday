    ...
    <section id="header">
        ...
        <nav id="nav">
            <ul>
                ...
                <li><a href="right-sidebar.html">RECIPES</a></li>
                <li><a href="no-sidebar.html">TOOLS</a></li>
                <li>
                    <a href="#">SHARE</a>
                    <ul>
                        <li><a href="#">PLACE</a></li>
                        <li><a href="#">COKCTAIL</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
                        ...
                        <div class="row">
                            <div class="col-4 col-6-medium col-12-small">
                                <section class="box">
                                    ...
                                    <p>레몬 맛이 강한 아이스티와 어느 정도 비슷하고, 콜라의 단맛이 술을 중화시켜주어 마시기 쉽기 때문에 인기있는 칵테일 중 하나이다.</p>
                                    <footer>
                                        <ul class="actions">
                            ...
                            <div class="col-4 col-6-medium col-12-small">
                                <section class="box">
                                    ...
                                    <p>복숭아 향이 나며 맛은 약간 새콤한 느낌이다. 도수가 매우 낮으며, 덕분에 여성들에게 인기가 많은 칵테일이다.</p>
                                    <footer>
                                        <ul class="actions">
                                            <li><a href="#" class="button alt">Read more</a></li>
                                        </ul>
                            ...
                            <div class="col-4 col-6-medium col-12-small">
                                <section class="box">
                                    ...
                                    <p>멜론맛인 미도리와 스윗&사워 믹스의 레몬향이 어우러져서 상큼한 맛과 초록색 빛이 포인트이다.</p>
                                    <footer>
                                        <ul class="actions">
                                            <li><a href="#" class="button alt">Read more</a></li>
                                        </ul>
                            ...
                            <div class="col-4 col-6-medium col-12-small">
                                <section class="box">
                                    ...
                                    <p>Long Island Iced tea와 들어가는 술은 한가지 다르고 도수가 좀 더 낮고 달달하고 보기좋고 상큼하다</p>
                                    <footer>
                                        <ul class="actions">
                                            <li><a href="#" class="button alt">Read more</a></li>
                                        </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col-4 col-6-medium col-12-small">
                    <section>
                        <header>
                            <h2 class="text-black-50">Cocktail Youtuber</h2>
                        </header>
                        <ul class="divided">
                ...
                <div class="col-4 col-6-medium col-12-small">
                    <section>
                        <header>
                            <h2 class="text-black-50">Another Sites</h2>
                        </header>
                        <ul class="divided">
                ...
                <div class="col-4 col-12-medium">
                    <section>
                        ...
                        <ul class="contact">
                            <li>
                                <h3 class="text-black-50">Address</h3>
                                <p>
                            ...
                            <li>
                                <h3 class="text-black-50">Mail</h3>
                                <p><a href="#">alcoholiday@gmail.com</a></p>
                            </li>
                            <li>
                                <h3 class="text-black-50">Phone</h3>
                                <p>042) 670-0600</p>
                            </li>
                        </ul>
                    </section>
